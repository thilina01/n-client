...
@Component({
  selector: 'sales-invoice-table',
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['./salesInvoiceTable.scss'],
  templateUrl: './salesInvoiceTable.html',
})
export class SalesInvoiceTable {
  ...
  onRowDblclick(data: any): void {
    this.router.navigate(['/pages/salesInvoice/form/' + data.id]);
  }

  navigateToForm(id: any): void {
    this.router.navigate(['/pages/salesInvoice/form/' + id]);
  }
